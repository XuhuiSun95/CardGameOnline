...
void InvalidOperation::__set_err_code(const int32_t val) {
  this->err_code = val;
}
...
uint32_t InvalidOperation::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("err_code", ::apache::thrift::protocol::T_I32, 1);
...
void InvalidOperation::printTo(std::ostream& out) const {
  ...
  out << "err_code=" << to_string(err_code);
